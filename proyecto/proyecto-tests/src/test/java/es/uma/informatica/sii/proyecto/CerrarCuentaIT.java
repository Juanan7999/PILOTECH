...
import java.net.URL;
@Requisitos( value = {"RF9"})
public class CerrarCuentaIT {
  ...
  public void cerrarCuentaIT() {
    ...
    driver.findElement(By.cssSelector("#cuenta > .card-body")).click();
    driver.findElement(By.id("cuentas")).click();
    driver.findElement(By.id("seg:j_idt16:2:botonCierraSeg")).click();
    driver.findElement(By.cssSelector("#seg li")).click();
    assertThat(driver.findElement(By.cssSelector("#seg li")).getText(), is("La cuenta aun tiene saldo"));
  }
}

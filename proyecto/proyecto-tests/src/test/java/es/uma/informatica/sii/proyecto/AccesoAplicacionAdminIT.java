...
import java.net.URL;
public class AccesoAplicacionAdminIT {
  ...
  @Test
  public void accesoAplicacionAdminIT() {
    ...
    driver.findElement(By.cssSelector(".text-light")).click();
    assertThat(driver.findElement(By.cssSelector(".text-light")).getText(), is("Usuario: ponciano"));
  }
}

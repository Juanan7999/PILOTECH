...
public class BajaClienteJuridicoIT {
  ...
  @Test
  public void bajaClienteJuridicoIT() {
    ...
    driver.findElement(By.id("formulario:j_idt19:1:botonBaja")).click();
    driver.findElement(By.cssSelector("tr:nth-child(2)")).click();
    assertThat(driver.findElement(By.id("formulario:j_idt19:1:textoEstado2")).getText(), is("baja"));
  }
}

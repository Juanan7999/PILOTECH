...
import java.net.URL;
@Requisitos(value = { "RF4" })
public class BajaClienteFisicoIT {
  ...
  @Test
  public void bajaClienteFisicoIT() {
    ...
    driver.findElement(By.id("formulario:j_idt16:4:botonBaja")).click();
    driver.findElement(By.cssSelector("tr:nth-child(5) > td:nth-child(6)")).click();
    assertThat(driver.findElement(By.id("formulario:j_idt16:4:textoEstado2")).getText(), is("baja"));
  }
}

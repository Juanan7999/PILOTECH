...
public interface GestionCuenta {
	...
	public Segregada abrirCuentaFintechSegregada(Usuario usuario, Segregada cf, Cliente c, CuentaReferencia cr) throws UsuarioNoEsAdministrativoException;
	...
	public void anadirAutorizados(Usuario usuario, List<PersonaAutorizada> lpa, CuentaFintech cf) throws UsuarioNoEsAdministrativoException, ClienteNoJuridicoException;
	...
	public void modificarAutorizados(Usuario usuario, PersonaAutorizada pa) throws UsuarioNoEsAdministrativoException, ClienteNoJuridicoException, PersonaAutorizadaNoExistenteException;
	...
	public void eliminarAutorizados(Usuario usuario, PersonaAutorizada pa) throws UsuarioNoEsAdministrativoException, ClienteNoJuridicoException, PersonaAutorizadaNoExistenteException;
	...
	public void cerrarCuentaSegregada(Usuario usuario, Segregada s) throws UsuarioNoEsAdministrativoException, SegregadaNoExistenteException, CuentaSinSaldo0Exception;

...
CREATE TABLE CLIENTE (ID VARCHAR NOT NULL, CIUDAD VARCHAR NOT NULL, CODIGOPOSTAL INTEGER NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR NOT NULL, FECHA_ALTA DATE NOT NULL, FECHA_BAJA DATE, IDENTIFICACION VARCHAR NOT NULL UNIQUE, PAIS VARCHAR NOT NULL, TIPO_CLIENTE VARCHAR NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE EMPRESA (ID VARCHAR NOT NULL, CIUDAD VARCHAR NOT NULL, CODIGOPOSTAL INTEGER NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR NOT NULL, FECHA_ALTA DATE NOT NULL, FECHA_BAJA DATE, IDENTIFICACION VARCHAR NOT NULL UNIQUE, PAIS VARCHAR NOT NULL, RAZON_SOCIAL VARCHAR NOT NULL, TIPO_CLIENTE VARCHAR NOT NULL, PRIMARY KEY (ID))
CREATE TABLE INDIVIDUAL (ID VARCHAR NOT NULL, APELLIDO VARCHAR NOT NULL, CIUDAD VARCHAR NOT NULL, CODIGOPOSTAL INTEGER NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR NOT NULL, FECHA_ALTA DATE NOT NULL, FECHA_BAJA DATE, FECHA_NACIMIENTO DATE, IDENTIFICACION VARCHAR NOT NULL UNIQUE, NOMBRE VARCHAR NOT NULL, PAIS VARCHAR NOT NULL, TIPO_CLIENTE VARCHAR NOT NULL, PRIMARY KEY (ID))
